...
const NavBar = () => {
  ...
  return (
    <div className='flex flex-col items-center justify-center relative translate-x-[-50%] translate-y-[10%] left-[50%] top-[0%] z-[1] bg-aboutbgimg bg-contain bg-no-repeat w-full'>
